...
%% @todo Lots of things to remove here.

init({IPAddress, Port,
      {M,F,A} = OnStartup, OnShutdown, Label}) ->
    process_flag(trap_exit, true),

%% @todo Isn't that the same as IPAddress/Port anyway?
...
%% @todo Definitely should have a way to print this error when
%% the listener fails to start in Ranch.
%        {error, Reason} ->
...
%% @todo Yeah this is currently a problem. :-)
%%    apply(M, F, A ++ [IPAddress, Port]).
